      ...
      <div className="min-h-screen bg-gray-950 py-10 px-3 lg:px-25 xl:px-35 lg:py-15 2xl:px-45 ">
        <section className="">
          ...
          <div className="flex  flex-col w-full  mt-20 items-center  justify-center">
            ...
            <div
              id="About me card"
              className="text-white  w-full flex p-10 h-ful max-lg:flex-col max-lg:space-y-15 lg:justify-between max-lg:items-center max-lg:justify-items-center max-lg:text-center lg:space-x-20 "
            >
              {" "}<span className="flex flex-col max-lg:text-center max-lg:items-center max-lg:justify-center lg:w-[50%] space-y-2 ">
            ...
            <span className="flex flex-col lg:w-[50%] space-y-2 ">
                <h1 className="text-4xl text-white font-bold">
                  {" "}
                  Who<span className="text-red-900 font-black"> I'm I</span>
                </h1>
